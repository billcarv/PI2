 ...
 */
public class ConsultaEspecialidade2 extends javax.swing.JFrame {
    ...
    public ConsultaEspecialidade2(Object conect) {
        con = (Conexao) conect;
        criaTabelaConsEsp();
        initComponents();
   ...
   private void criaTabelaConsEsp(){ 
        ...
        pesquisarConsCliente("SELECT codigo,nome FROM especialidade  "
    ...
    private void initComponents() {
        ...
        cmbConsultaCliente.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Código", "Nome" }));
